...
public class Fecha  {
    ...
    public static void registrarFecha(ArrayList<Equipo> Equipos) {
        ...
        //         jugadorEncontrado = JugadorServicio.encontrarJugador(equipoLocal, jugadorBuscado);
        ...
        //     jugadorEncontrado = JugadorServicio.encontrarJugador(equipoEncontrado, jugadorBuscado);
